...
@Component({
  selector: 'app-coktail-list',
  templateUrl: './coktail-list.component.html',
  styleUrls: ['./coktail-list.component.scss']
})
export class CoktailListComponent implements OnInit {
	cocktails: Cocktail[] = [
	{
		name: 'Mojito',
		...
		description: 'Le Bellini, en plus d’être un incontournable, extrêmement facile à réaliser puisqu’il s’agit d’un simple mélange de 11cl de Prosecco et de 5cl de purée de pêche blanche. Voilà qui devrait vous laisser le temps de préparer à vos invités une belle planche de charcuterie !'
	}, {
		name: "L'Aquavit Fresh",
